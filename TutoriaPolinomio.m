...
%Polinomios con los siguientes códigos
...
%contruir un polinomio de Lagranje sería un tanto como
poly([1 2])
%no entregará un resultado, dado que en el polinomio de Lagranje
...
%debemos realizar el siguiente código
